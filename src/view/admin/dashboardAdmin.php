...
<head>
	...
	<link rel="stylesheet" href="?page=admin123">
</head>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0 mx-auto">
						<li class="nav-item">
							<a class="nav-link active" aria-current="page" href="?page=admin123">Home</a>
						</li>
						<li class="nav-item">
	...
	<section id="ucapan">
		<div class="ucapan">
			...
			<div class="buttonCepat">
				<a href="?page=videos">See Videos</a>
				<a href="?page=users">See Users</a>
			</div>
		</div>
	</section>
